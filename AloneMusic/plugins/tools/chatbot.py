...
async def chatModeHandler(bot, msg: Message):
    ...
    if text.startswith("ceyda"):  # * Mesaj buse ile başlıyorsa cevap veriyoruz
        ...
        ["selam", "slm", "sa", "selamlar", "selamm"], text
    ):  # * Selam yazısı metnin içinde varsa cevap veriyoruz
        ...
        ["teşekkürler", "tesekkürler", "tşkr"], text
    ):  # * Selam yazısı metnin içinde varsa cevap veriyoruz
        ...
        ["bilmiyorum", "bilmiyom", "bilmiyos"], text
    ):  # * Selam yazısı metnin içinde varsa cevap veriyoruz
